/*! For license information please see index.js.LICENSE.txt */ ! function (e, t) {
	...
	return (() => {
		...
		var e = o(573);
		class t extends e.FieldTextInput {
			constructor(e, t, r) {
			...
			doClassValidation_(e) {
				...
				return !t || isNaN(t.getTime()) ? null : r(e) ? e : i(t)
			}
			getText_() {
			...
			showDropdown() {
				this.htmlInput_ && (e.utils.dom.addClass(this.htmlInput_, "blocklyDateInput"), this.htmlInput_.showPicker())
			}
			widgetCreate_() {
